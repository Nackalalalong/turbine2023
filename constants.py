...
TUNE_RESULT = {
    ...
    'tide-w-a': {'lr': 0.00021678258939580435, 'batch_size': 128, 'hidden_dim': 128, 'encoder_layer_num': 2, 'decoder_layer_num': 2, 'temporal_decoder_hidden': 64, 'decoder_output_dim': 16, 'dropout_rate': 0.1}
}